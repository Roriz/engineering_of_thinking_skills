# Rollbar Error Payload Extraction & Parsing Guide
...
## 1. Top-Level Telemetry & Environment
...
### B. Formatted Trace Exception & Frames
`body.trace`:
...
1. **Extract Message & Class**: `CompileError`: WASM validation error (`function body too big`).
